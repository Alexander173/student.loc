...
<img src="{{asset('storage/img_lk/default_avatar.jpg')}}" class="img-responsive rounded-circle border-primary img-thumbnail" width="200" height="200"/>
...
@endif
@else
<img src="{{asset('storage/img_lk/'.$name_temp->image->img_src)}}" class="img-responsive rounded-circle border-primary img-thumbnail" width="200" height="200"/>
